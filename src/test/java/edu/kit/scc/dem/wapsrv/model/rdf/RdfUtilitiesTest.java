...
class RdfUtilitiesTest {
    ...
    final void testRdfLiteralFromCalendar() {
        ...
        Literal literalDefault = RdfUtilities.rdfLiteralFromCalendar(cal);
        //TODO: Assertion changed, check validity
        assertThat(literalDefault.stringValue(), startsWith("1979-04-29T13:56:13Z"));
        cal.set(2018, 8, 11, 11, 0, 0); // month 0-value based 8-> September, 0-> January
        Literal literalDefault2 = RdfUtilities.rdfLiteralFromCalendar(cal);
        //TODO: Assertion changed, check validity
        assertThat(literalDefault2.stringValue(), startsWith("2018-09-11T11:00:00Z"));
    }
